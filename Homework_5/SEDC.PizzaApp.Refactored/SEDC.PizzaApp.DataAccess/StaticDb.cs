     ...
     public static class StaticDb
        {
            ...
            Feedbacks = new List<Feedback>
            {
                new Feedback
                {
                    Id =1,
                    Name = "DeliveryPeriod",
                    Email = "betinskaelena@gmail.com",
                    Message = "Delivery time was too long."
                },
                new Feedback
                {
                    Id =2,
                    Name = "QualityOfOrder",
                    Email = "aleksandarivanovski@gmail.com",
                    Message = "I ordered pineapple pizza, but they brought me a Margaritta."
                }
            };
